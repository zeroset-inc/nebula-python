...
class ConnectorsResource:
    ...
    async def connect(
    ...
    ) -> models.NebulaResultsConnectorConnectResponse:
        """
        ...
        try:
            return models.NebulaResultsConnectorConnectResponse.model_validate(_raw)
    ...
    async def disconnect(
        ...
        *,
    ...
    ) -> models.NebulaResultsConnectorDisconnectResponse:
        """
        ...
        try:
            return models.NebulaResultsConnectorDisconnectResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def list(
        self,
        collection_id: str
    ) -> models.NebulaResultsListConnectorConnectionResponse:
        """
        ...
        try:
            return models.NebulaResultsListConnectorConnectionResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]

    async def list_providers(
        self
    ) -> models.NebulaResultsListStr:
        """
        ...
        try:
            return models.NebulaResultsListStr.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def retrieve(
        self,
        connection_id: str
    ) -> models.NebulaResultsConnectorConnectionResponse:
        """
        ...
        try:
            return models.NebulaResultsConnectorConnectionResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def sync(
        self,
        connection_id: str
    ) -> models.NebulaResultsConnectorSyncResponse:
        """
        ...
        try:
            return models.NebulaResultsConnectorSyncResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
