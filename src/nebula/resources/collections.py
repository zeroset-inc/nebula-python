...
class CollectionsResource:
    ...
    async def create(
    ...
    ) -> models.NebulaResultsCollectionResponse:
        """
        ...
        try:
            return models.NebulaResultsCollectionResponse.model_validate(_raw)
    ...
    async def list(
        ...
        *,
    ...
    ) -> models.PaginatedNebulaResultListCollectionResponse:
        """
        List collections
        ...
        _raw = await self._core.request({
            ...
            "path": "/v1/collections",
            "path_params": {},
            "query": {"ids": ids, "name": name, "offset": offset, "limit": limit, "owner_only": owner_only, "workspace_id": workspace_id},
            "idempotent": True,
        })
        try:
            return models.PaginatedNebulaResultListCollectionResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
