...
class MemoriesResource:
    ...
    async def create_upload(
        ...
        content_type: str,
        file_size: int
    ) -> models.NebulaResultsPresignedUploadResponse:
        """
        ...
        try:
            return models.NebulaResultsPresignedUploadResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def delete(
        self,
        id: str
    ) -> models.NebulaResultsGenericBooleanResponse:
        """
        Delete an engram
        ...
        try:
            return models.NebulaResultsGenericBooleanResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def delete_upload(
        self,
        s3_key: str
    ) -> models.NebulaResultsGenericMessageResponse:
        """
        ...
        try:
            return models.NebulaResultsGenericMessageResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def list(
        ...
        *,
        ...
        _raw = await self._core.request({
            ...
            "path": "/v1/memories",
            "path_params": {},
            "query": {"ids": ids, "offset": offset, "limit": limit, "chunks_limit": chunks_limit, "owner_only": owner_only, "collection_ids": collection_ids, "metadata_filters": metadata_filters, "min_applied_wal_seq": min_applied_wal_seq},
            "idempotent": True,
        })
        try:
            return models.WrappedEngramsResponse.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
    ...
    async def retrieve(
        ...
        try:
            return models.NebulaResultsEngram.model_validate(_raw)
        except ValidationError:
            return _raw  # type: ignore[return-value]
