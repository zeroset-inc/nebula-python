...
class ManagementResource(SyncAPIResource):
    ...
    def sync_subscription(
        ...
        *,
        ...
        """Sync subscription from Stripe webhook with enhanced security.

        Supports HMAC
        signature verification, IP allowlisting, and idempotency.
        """
        return self._post(
            "/v1/management/sync-subscription",
...
class ManagementResourceWithRawResponse:
    def __init__(self, management: ManagementResource) -> None:
        ...
        self.sync_subscription = to_raw_response_wrapper(
            management.sync_subscription,
        )
...
class AsyncManagementResourceWithRawResponse:
    def __init__(self, management: AsyncManagementResource) -> None:
        ...
        self.sync_subscription = async_to_raw_response_wrapper(
            management.sync_subscription,
        )
...
class ManagementResourceWithStreamingResponse:
    def __init__(self, management: ManagementResource) -> None:
        ...
        self.sync_subscription = to_streamed_response_wrapper(
            management.sync_subscription,
        )
...
class AsyncManagementResourceWithStreamingResponse:
    def __init__(self, management: AsyncManagementResource) -> None:
        ...
        self.sync_subscription = async_to_streamed_response_wrapper(
            management.sync_subscription,
        )
