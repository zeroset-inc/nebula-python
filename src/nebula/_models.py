...
#   timestamp: 2026-05-19T00:33:43+00:00
...
class PaginatedEngram(BaseModel):
    """
    Cursor-paginated list of Engram entries. The wire envelope is ``{data, next_cursor, has_more}``.
    """
